"""Diagnostic: Uncle-informed sibling tests — three approaches.

Compares calibration under null for:
  Approach 0 (baseline): Current Wald χ² sibling test
  Approach 1 (F-test):   T_LR / T_PU ~ F(k, k) — ratio of sibling to parent-uncle divergence
  Approach 2 (LR nest):  Likelihood-ratio: does splitting P into L,R improve beyond P-vs-U?
  Approach 3 (uncle var): Use uncle-calibrated variance to adjust sibling statistic
