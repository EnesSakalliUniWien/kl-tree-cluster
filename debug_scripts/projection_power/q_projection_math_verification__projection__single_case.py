"""
Purpose: Verify projection-math assumptions used by the statistical test pipeline.
Inputs: Synthetic projection matrices and controlled test vectors.
Outputs: Console math checks and error diagnostics.
Expected runtime: ~5-30 seconds.
How to run: python debug_scripts/projection_power/q_projection_math_verification__projection__single_case.py
"""
