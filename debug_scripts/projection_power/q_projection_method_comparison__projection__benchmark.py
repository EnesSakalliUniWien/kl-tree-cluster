"""
Purpose: Compare sparse vs orthonormal projection methods on clustering accuracy.
...
How to run: python debug_scripts/projection_power/q_projection_method_comparison__projection__benchmark.py
"""
