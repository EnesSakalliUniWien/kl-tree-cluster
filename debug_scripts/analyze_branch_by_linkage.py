"""
Analyze branch length correlations with statistical tests
across different linkage methods and distance metrics.

Question: Do branch lengths work as predictors for all inference methods,
or only for certain hierarchical clustering configurations?
"""
