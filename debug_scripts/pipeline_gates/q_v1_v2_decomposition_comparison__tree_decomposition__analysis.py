"""
Purpose: Compare decompose_tree (v1) vs decompose_tree_v2 (signal localization).
...
How to run: python debug_scripts/pipeline_gates/q_v1_v2_decomposition_comparison__tree_decomposition__analysis.py
"""
