"""
Purpose: Debug script: Demonstrate impact of min sample size gate (n >= 10) on Case 18.
...
How to run: python debug_scripts/pipeline_gates/q_min_sample_size_gate_effect__pipeline_gates__case18.py
"""
