"""Debug script to investigate mathematical inconsistency in branch length usage.

This script analyzes:
1. What units/scale branch lengths have from linkage
2. How they're currently used in variance adjustment
3. Whether the Felsenstein adjustment makes sense with linkage distances
"""
...
def analyze_variance_scaling():
    ...
    print(f"\nWith Felsenstein adjustment (variance × branch_sum):")
