"""
Purpose: Investigate under-splitting behavior in benchmark case 19.
Inputs: Benchmark case 19 setup and pipeline outputs.
Outputs: Console diagnosis of possible under-splitting causes.
Expected runtime: ~10-90 seconds.
How to run: python debug_scripts/case_studies/q_case19_undersplitting_investigation__pipeline__case19.py
"""
