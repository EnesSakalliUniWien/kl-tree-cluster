"""Test Neighbor-Joining tree construction vs UPGMA (average linkage).

Neighbor-Joining (Saitou & Nei, 1987) is a phylogenetic method that:
- Does NOT assume a molecular clock (unlike UPGMA)
- Produces unrooted trees
- Better handles rate variation across lineages
- Has O(n³) time complexity

For clustering, we need to:
1. Build NJ tree from distance matrix
2. Root the tree (midpoint rooting)
3. Convert to scipy linkage format or extract clusters
"""
