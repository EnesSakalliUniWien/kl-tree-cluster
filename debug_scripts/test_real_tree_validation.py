"""
Test real tree structures for validity.

This script generates synthetic data, builds trees using different linkage methods,
and validates that all parent-child relationships satisfy n_child < n_parent.
"""
