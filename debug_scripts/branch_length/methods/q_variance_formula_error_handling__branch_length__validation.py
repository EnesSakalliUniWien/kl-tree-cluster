"""
Purpose: Debug script to test the error-raising behavior for invalid tree structures.
...
How to run: python debug_scripts/branch_length/methods/q_variance_formula_error_handling__branch_length__validation.py
"""
