"""
Purpose: Benchmark: Compare clustering with and without branch length weighting.
...
How to run: python debug_scripts/branch_length/methods/q_branch_length_weighting_benchmark__branch_length__benchmark.py
"""
