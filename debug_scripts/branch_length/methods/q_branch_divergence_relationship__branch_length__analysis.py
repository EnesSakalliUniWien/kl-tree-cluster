"""
Purpose: Analyze the mathematical relationship between branch length and divergence.
...
How to run: python debug_scripts/branch_length/methods/q_branch_divergence_relationship__branch_length__analysis.py
"""
