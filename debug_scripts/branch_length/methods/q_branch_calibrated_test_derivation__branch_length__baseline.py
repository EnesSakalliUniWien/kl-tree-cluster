"""
Purpose: Option B: Branch-Length Calibrated Divergence Test.
...
How to run: python debug_scripts/branch_length/methods/q_branch_calibrated_test_derivation__branch_length__baseline.py
"""
