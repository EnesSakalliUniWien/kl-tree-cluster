"""
Purpose: Trace why harmonic weighting decreases boundary detection AUC.
...
How to run: python debug_scripts/branch_length/methods/q_harmonic_weighting_effect_trace__branch_length__diagnostic.py
"""
