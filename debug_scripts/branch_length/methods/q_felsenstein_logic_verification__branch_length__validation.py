"""
Purpose: Verify Felsenstein's PIC logic and our implementation.
...
How to run: python debug_scripts/branch_length/methods/q_felsenstein_logic_verification__branch_length__validation.py
"""
