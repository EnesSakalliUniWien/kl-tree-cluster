"""
Purpose: Debug script to analyze branch length scale and variance components.
...
How to run: python debug_scripts/branch_length/methods/q_branch_length_scale_variance_diagnostic__branch_length__diagnostic.py
"""
