"""
Purpose: Diagnostic: Test whether leaf-count-weighted branch lengths improve sibling calibration.
...
How to run: python debug_scripts/branch_length/methods/q_leaf_weighted_branch_length_calibration__branch_length__null_sim.py
"""
...
from kl_clustering_analysis.hierarchy_analysis.statistics.sibling_divergence.pair_testing.pooled_variance.categorical_shape import _flatten_categorical
