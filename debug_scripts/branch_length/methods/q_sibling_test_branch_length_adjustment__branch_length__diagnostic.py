"""
Purpose: Debug script to verify branch-length adjustment in sibling divergence test.
...
How to run: python debug_scripts/branch_length/methods/q_sibling_test_branch_length_adjustment__branch_length__diagnostic.py
"""
