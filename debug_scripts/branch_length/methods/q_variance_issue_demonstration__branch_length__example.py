"""
Purpose: Demonstrates the mathematical issues with variance calculations.
...
How to run: python debug_scripts/branch_length/methods/q_variance_issue_demonstration__branch_length__example.py
"""
