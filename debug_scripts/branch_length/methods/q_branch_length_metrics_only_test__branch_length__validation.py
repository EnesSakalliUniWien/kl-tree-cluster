"""
Purpose: Test ONLY branch length metrics (actual distances, not heights).
...
How to run: python debug_scripts/branch_length/methods/q_branch_length_metrics_only_test__branch_length__validation.py
"""
