"""
Purpose: Debug: Compare A with children of B (asymmetric sibling comparison).
...
How to run: python debug_scripts/diagnostics/q_asymmetric_a_vs_children_b_comparison__sibling_tests__diagnostic.py
"""
