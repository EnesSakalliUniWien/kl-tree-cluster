"""
Purpose: Mathematical Models for Branch Length Integration.
...
How to run: python debug_scripts/diagnostics/q_integration_model_comparison__scoring_models__analysis.py
"""
