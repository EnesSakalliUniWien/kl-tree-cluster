"""Debug script to analyze sibling testing, iteration, and cluster merging logic.

Questions to answer:
1. How does the iteration/traversal work?
2. How are sibling tests applied?
3. Is it correct to only check siblings?
4. How does post-hoc merging work?
"""
