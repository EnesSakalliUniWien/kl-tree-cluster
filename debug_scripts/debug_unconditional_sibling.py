"""Diagnostic: Sibling test calibration when run unconditionally at ALL binary parents.

Tests whether the sibling test alone (no edge gate) gives proper Type I control
under null hypothesis, and whether BH correction works properly with m = all parents.
"""
