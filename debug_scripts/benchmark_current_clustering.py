"""Benchmark the current clustering pipeline to verify it finds clusters correctly.

Tests with synthetic data with known ground truth clusters.
Compares behavior WITH and WITHOUT branch-length adjustment.
"""
