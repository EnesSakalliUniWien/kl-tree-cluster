"""Debug script to compare variance formulas and their effect on clustering.

Investigates:
1. Naive variance: θ(1-θ)/n_child
2. Nested variance: θ(1-θ) × (1/n_child - 1/n_parent)
3. With branch length: variance × BL
"""
