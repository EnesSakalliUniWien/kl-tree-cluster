"""
Debug script to test branch length integration in distribution calculation.

Compares:
1. Current method: weighted by leaf_count only
2. Harmonic method: weighted by leaf_count / branch_length
"""
