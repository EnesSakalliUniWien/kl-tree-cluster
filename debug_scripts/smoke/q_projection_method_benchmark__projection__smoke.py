"""
Purpose: Compare projection methods in a quick benchmark configuration.
Inputs: Synthetic/benchmark inputs configured in-script.
Outputs: Console metrics comparing projection variants.
Expected runtime: ~10-60 seconds.
How to run: python debug_scripts/smoke/q_projection_method_benchmark__projection__smoke.py
"""
