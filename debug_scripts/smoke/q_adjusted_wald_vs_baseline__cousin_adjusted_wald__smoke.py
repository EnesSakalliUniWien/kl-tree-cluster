"""
Purpose: Smoke-test adjusted Wald sibling test against baseline behavior.
Inputs: Small synthetic cases defined in-script.
Outputs: Console table comparing adjusted and baseline outcomes.
Expected runtime: ~10-90 seconds.
How to run: python debug_scripts/smoke/q_adjusted_wald_vs_baseline__cousin_adjusted_wald__smoke.py
"""
