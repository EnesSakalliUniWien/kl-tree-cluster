"""Diagnose the full pipeline: edge test → sibling test → _should_split gates.

Traces every gate decision for wald, cousin_adjusted_wald, and cousin_ftest.
Uses _should_split (v1) and _should_split_v2 to show exactly which gate
blocks splitting.

Usage:
    python debug_scripts/diagnose_pipeline.py
"""
