"""
Test branch lengths for EACH of the two statistical tests:
1. Child-Parent test: Does child differ from parent?
2. Sibling test: Do siblings differ from each other?

The branch lengths may have different predictive power for each test.
"""
