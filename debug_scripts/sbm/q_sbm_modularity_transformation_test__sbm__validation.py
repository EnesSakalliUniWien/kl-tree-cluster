"""
Purpose: Test modularity matrix transformation on all SBM test cases.
...
How to run: python debug_scripts/sbm/q_sbm_modularity_transformation_test__sbm__validation.py
"""
