"""
Purpose: Check if the tree structure itself is wrong for noisy data.
...
How to run: python debug_scripts/tree_construction/q_tree_quality_diagnostic__tree_construction__diagnostic.py
"""
