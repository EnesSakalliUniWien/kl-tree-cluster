"""
Purpose: Test Inconsistency Coefficient as Predictive Feature.
...
How to run: python debug_scripts/tree_construction/q_inconsistency_coefficient_test__tree_metrics__validation.py
"""
