"""
Purpose: Explore tree height values in benchmark data.
...
How to run: python debug_scripts/tree_construction/q_tree_height_exploration__tree_construction__analysis.py
"""
