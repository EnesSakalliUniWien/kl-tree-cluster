"""
Purpose: Benchmark advanced tree construction methods.
...
How to run: python debug_scripts/tree_construction/q_advanced_tree_methods_benchmark__tree_construction__benchmark.py
"""
