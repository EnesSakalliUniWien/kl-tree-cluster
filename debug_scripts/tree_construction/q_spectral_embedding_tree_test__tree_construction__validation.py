"""
Purpose: Test Spectral Embedding + Hierarchical Clustering.
...
How to run: python debug_scripts/tree_construction/q_spectral_embedding_tree_test__tree_construction__validation.py
"""
