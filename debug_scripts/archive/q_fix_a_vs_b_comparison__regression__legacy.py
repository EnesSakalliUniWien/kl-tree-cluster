"""
Purpose: Legacy A-vs-B fix comparison script retained for regression traceability.
Inputs: Ad-hoc comparison setup in script.
Outputs: Console comparison output.
Expected runtime: ~10-90 seconds.
How to run: python debug_scripts/archive/q_fix_a_vs_b_comparison__regression__legacy.py
"""
