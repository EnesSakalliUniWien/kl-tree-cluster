...
def main():
    ...
    results_file = output_dir / f"umap_datasets_benchmark_{timestamp}.csv"
    ...
    try:
        ...
        # Save figure
        fig_path = output_dir / f"umap_datasets_benchmark_{timestamp}.png"
        plt.savefig(fig_path, dpi=150, bbox_inches="tight")
        print(f"Figure saved to: {fig_path}")

        # Create interactive Bokeh plot for digits
        print("\n  Creating interactive Bokeh plot with digit hover...")
        bokeh_path = output_dir / f"digits_interactive_{timestamp}.html"
