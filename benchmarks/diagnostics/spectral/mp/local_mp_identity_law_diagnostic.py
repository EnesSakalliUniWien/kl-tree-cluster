...
from benchmarks.diagnostics.spectral.mp.profile_spectral_backends import (
...
GENERATED_BY = "benchmarks.diagnostics.spectral.mp.local_mp_identity_law_diagnostic"
