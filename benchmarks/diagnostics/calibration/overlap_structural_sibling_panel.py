...
GENERATED_BY = "benchmarks.diagnostics.calibration.overlap_structural_sibling_panel"
...
def classify_structural_sibling_row(
    *,
    ...
    if homogeneity_gain_min < 0.02:
        ...
        return "weak_homogeneity_gain"
    if (
        delta_homogeneity_jaccard_topk < 0.25
        and max_sibling_edge_alignment < 0.50
    ):
...
def _analytical_rows_for_node(
    *,
    ...
    return {
        ...
        "left_edge_heterogeneity_jaccard_topk": float(
            left_edge_heterogeneity_jaccard
        ),
        "right_edge_heterogeneity_jaccard_topk": float(
            right_edge_heterogeneity_jaccard
        ),
        "max_edge_heterogeneity_jaccard_topk": float(
            max_edge_heterogeneity_jaccard
        ),
        "heterogeneity_subspace_consensus_jaccard_topk": float(
            heterogeneity_subspace_consensus_jaccard
        ...
        records.append(
            {
                ...
                "mean_heterogeneity_gain_max": float(
                    group["heterogeneity_gain_max"].mean()
                ),
