...
GENERATED_BY = "benchmarks.diagnostics.calibration.statistics.differential_statistic_validity_panel"
...
def compute_fisher_geometry_summary(
    ...
    *,
    ...
    variance_floor = float(min(variance_floors)) if variance_floors else float("nan")
    condition = (
        math.inf
