        ...
        out.append(
            {
                ...
                "edge_traversal_action": str(
                    trace_row.get("edge_traversal_action", "")
                ),
                "edge_traversal_stop_reason": str(
                    trace_row.get("edge_traversal_stop_reason", "")
                ),
                "is_leaf": bool(trace_row.get("is_leaf", False)),
                "n_children": int(trace_row.get("n_children", 0)),
                "n_descendant_leaves": int(
                    trace_row.get("n_descendant_leaves", 0)
                ),
                ...
                "sibling_different": bool(
                    trace_row.get("sibling_different", False)
                ),
                "sibling_skipped": bool(trace_row.get("sibling_skipped", False)),
                "sibling_gate_open": bool(
                    trace_row.get("sibling_gate_open", False)
                ),
                "left_branch_length": _finite_float(
                    trace_row.get("left_branch_length")
                ),
                "right_branch_length": _finite_float(
                    trace_row.get("right_branch_length")
                ),
