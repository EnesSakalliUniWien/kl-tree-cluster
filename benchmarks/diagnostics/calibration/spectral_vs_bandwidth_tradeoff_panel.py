...
GENERATED_BY = (
    "benchmarks.diagnostics.calibration.spectral_vs_bandwidth_tradeoff_panel"
)
...
def build_spectral_rows(
    *,
    ...
    delta_ari = (
        pd.to_numeric(signal_paired["ari_candidate"], errors="coerce")
        - pd.to_numeric(signal_paired["ari_baseline"], errors="coerce")
    )
