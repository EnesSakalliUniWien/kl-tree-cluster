...
from benchmarks.diagnostics.calibration.internal_support_threshold_validation import (
    evaluate_internal_support_threshold_rows,
    summarize_internal_support_threshold_rows,
)
from benchmarks.diagnostics.calibration.sibling_null_weight_rule_validation import (
            ...
            threshold_rows.append(
                {
                    ...
                    "n_stopped_or_null_records": int(
                        support.get("n_stopped_or_null_records", 0)
                    ),
                    ...
                    "local_max_weight_share": float(
                        support.get("local_max_weight_share", 1.0)
                    ),
...
def run_mixed_internal_calibration_sweep(
    *,
    ...
    if (
        ...
        q10_records = (
            pd.concat(q10_tables, ignore_index=True) if q10_tables else pd.DataFrame()
        )
        threshold_contexts = (
