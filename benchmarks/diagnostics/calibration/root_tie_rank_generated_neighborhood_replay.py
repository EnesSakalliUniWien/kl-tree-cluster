...
from benchmarks.diagnostics.calibration.selected_neighborhood_pvalue_interpolation_comparison import (
...
from benchmarks.diagnostics.calibration.selected_neighborhood_topology_frontier import (
...
GENERATED_BY = (
    ...
    "root_tie_rank_generated_neighborhood_replay"
)
...
PVALUE_CASE_SUMMARY_OUTPUT = (
    "generated_selected_neighborhood_pvalue_interpolation_case_summary.csv"
)
