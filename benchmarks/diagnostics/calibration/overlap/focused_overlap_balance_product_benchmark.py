...
GENERATED_BY = (
    "benchmarks.diagnostics.calibration.overlap.focused_overlap_balance_product_benchmark"
)
...
def run_focused_overlap_balance_product_benchmark(
    ...
    manifest = {
        ...
        "outputs": {
            ...
            "conditional_law_component_summary": str(config.conditional_law_component_summary_path),
