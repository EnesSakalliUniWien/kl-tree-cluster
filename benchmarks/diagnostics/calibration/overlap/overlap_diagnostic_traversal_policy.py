...
GENERATED_BY = "benchmarks.diagnostics.calibration.overlap.overlap_diagnostic_traversal_policy"
...
def assign_diagnostic_traversal_policy(
    ...
    *,
    ...
    guard_subset = guard_subset.rename(columns={str(fragment_guard_metric): "fragment_guard_value"})
        ...
        records.append(
            {
                ...
                "null_like_count": int(
                    ...
                    - (structural_role.eq("null_like") & guard_role.eq("null_like")).sum()
                ),
                ...
                "signal_truth_aligned_count": int(structural_role.eq("signal_truth_aligned").sum()),
                "signal_truth_misaligned_count": int(
                    structural_role.eq("signal_truth_misaligned").sum()
                ),
                "median_fragment_guard_value": _finite_median(group["fragment_guard_value"]),
