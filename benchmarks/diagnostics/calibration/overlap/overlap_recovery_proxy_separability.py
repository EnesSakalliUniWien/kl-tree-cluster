...
GENERATED_BY = "benchmarks.diagnostics.calibration.overlap.overlap_recovery_proxy_separability"
    ...
    return pd.DataFrame(
        {
            ...
            "proxy_truth_role": joined["truth_geometry_mode"].astype(str).map(_proxy_truth_role),
