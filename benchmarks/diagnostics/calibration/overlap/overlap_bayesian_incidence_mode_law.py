...
GENERATED_BY = "benchmarks.diagnostics.calibration.overlap.overlap_bayesian_incidence_mode_law"
...
def build_bayesian_incidence_mode_rows(
    *,
    ...
    rows["branch_incidence_geometry_status"] = rows["branch_incidence_geometry_status"].fillna(
        "root_or_unobserved_branch_incidence"
    )
    ...
    context_negative_emergent = selected_pass & soft_pass & ~context_pass & ~branch_aligned
        ...
        records.append(
            {
                ...
                "context_margin_pass": bool(context_pass.loc[idx]),
                "soft_structure_pass": bool(soft_pass.loc[idx]),
                "branch_incidence_geometry_status": str(row["branch_incidence_geometry_status"]),
