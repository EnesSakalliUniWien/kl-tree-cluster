...
def evaluate_sibling_null_calibration_rows(
    ...
    *,
    ...
    if missing:
        raise ValueError(f"Sibling-null calibration panel is missing columns: {sorted(missing)!r}.")
    ...
    rows = pd.DataFrame(
        {
            ...
            "sibling_neg_log10_p_value": -np.log10(np.maximum(p_values, P_VALUE_FLOOR)),
            ...
            "is_external_selected_tail_context": role.isin(EXTERNAL_SIBLING_CONTEXT_ROLES),
