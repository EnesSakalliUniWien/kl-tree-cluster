...
GENERATED_BY = "benchmarks.diagnostics.calibration.overlap_weak_zone_separability"
...
def add_derived_metrics(rows: pd.DataFrame) -> pd.DataFrame:
    ...
    enriched["context_homogeneity_margin"] = (
        pd.to_numeric(enriched["homogeneity_gain_min"], errors="coerce")
