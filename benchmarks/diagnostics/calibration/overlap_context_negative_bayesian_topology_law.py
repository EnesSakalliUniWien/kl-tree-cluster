...
GENERATED_BY = (
    ...
    "overlap_context_negative_bayesian_topology_law"
)
...
class OverlapContextNegativeBayesianTopologyLawConfig:
    ...
    def rows_path(self) -> Path:
        return (
            self.output_dir
            / "overlap_context_negative_bayesian_topology_rows.csv"
        )
    ...
    def component_summary_path(self) -> Path:
        return (
            self.output_dir
            / "overlap_context_negative_bayesian_topology_component_summary.csv"
        )
    ...
    def summary_path(self) -> Path:
        return (
            self.output_dir
            / "overlap_context_negative_bayesian_topology_summary.csv"
        )
        ...
        records.append(
            {
                ...
                "selected_family_log_bayes_factor_lower": float(
                    selected_family.loc[idx]
                ),
