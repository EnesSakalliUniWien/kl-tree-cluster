...
GENERATED_BY = (
    ...
    "root_selected_conditional_tilt_feasibility_panel"
)
...
def summarize_root_selected_conditional_tilt_feasibility_rows(
    ...
    full_missing = full["tilt_feasibility_status"].astype(str).eq(
        "missing_conditioned_support_pool"
    )
    required_missing = required["tilt_feasibility_status"].astype(str).eq(
        "missing_conditioned_support_pool"
    )
    full_outside = full["tilt_feasibility_status"].astype(str).eq(
        "target_outside_current_support_hull_fail_closed"
    )
    required_outside = required["tilt_feasibility_status"].astype(str).eq(
        "target_outside_current_support_hull_fail_closed"
    )
