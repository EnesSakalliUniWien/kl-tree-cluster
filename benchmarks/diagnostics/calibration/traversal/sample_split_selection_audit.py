...
def _subset_feature_space(
    ...
    original_column_indices = [
        column_index for block in selected_blocks for column_index in block.column_indices
    ]
    new_position_by_old = {
    ...
    *,
    ...
    if feature_space is not None and feature_space.has_continuous_blocks:
        return FeatureSplit(
            ...
            test_data=test_data,
            selection_feature_space=continuous_feature_space_from_columns(selection_data.columns),
