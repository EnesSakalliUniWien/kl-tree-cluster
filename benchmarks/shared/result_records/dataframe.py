    ...
    records = [
        {
            ...
            "gate2_sec": row.gate2_sec,
            "gate2_contrast_covariance_sec": row.gate2_contrast_covariance_sec,
            "gate2_projection_sec": row.gate2_projection_sec,
            "gate2_wald_statistic_sec": row.gate2_wald_statistic_sec,
            "gate2_tree_bh_sec": row.gate2_tree_bh_sec,
            ...
            "gate3_sec": row.gate3_sec,
            "gate3_pair_record_collection_sec": row.gate3_pair_record_collection_sec,
            "gate3_inflation_fit_sec": row.gate3_inflation_fit_sec,
            "gate3_adjusted_tests_sec": row.gate3_adjusted_tests_sec,
            "gate3_sibling_fdr_sec": row.gate3_sibling_fdr_sec,
