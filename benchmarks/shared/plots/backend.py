"""Matplotlib backend configuration for benchmark plotting."""

from __future__ import annotations

import os

DEFAULT_BENCHMARK_BACKEND = "Agg"
...
def configure_matplotlib_backend() -> str:
    ...
    """
    backend = os.environ.setdefault("MPLBACKEND", DEFAULT_BENCHMARK_BACKEND)
...
__all__ = ["DEFAULT_BENCHMARK_BACKEND", "configure_matplotlib_backend"]
