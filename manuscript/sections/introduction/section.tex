...
sibling stage. That difference is important: the present draft should be read as
a methods specification and validation plan, not as a proof of exact selective
Type~I error control.

KL-TE works on typed feature blocks rather than one universal binary
