...
KL-TE does not currently derive an exact selective law for its tree-selected
sibling tests. Instead, it implements a discrete-data projected-Wald testing
pipeline with an empirical-null inflation layer for the sibling stage. That
difference is important: the present draft should be read as a methods
specification and validation plan, not as a proof of exact selective Type~I
error control.
