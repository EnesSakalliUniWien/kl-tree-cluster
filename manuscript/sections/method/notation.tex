...
$a_u$ & Satterthwaite reference scale for the projected sibling quadratic form. \\
$\nu_u$ & Effective sibling degrees of freedom. \\
$z_q$ & Sibling calibration context used by the empirical-null scale estimator. \\
$\pi_q$ & Sibling null weight used in empirical-null scale estimation. \\
$\hat c(z_u)$ & Context-weighted empirical-null scale estimate for sibling parent $u$. \\
