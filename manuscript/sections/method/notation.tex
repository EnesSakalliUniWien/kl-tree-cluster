...
$z_q$ & Sibling calibration context used by the empirical-null inflation estimator. \\
$s_q$ & Resolved sibling projection dimension whose logarithm defines $z_q$. \\
...
$h$ & Null-weighted bandwidth used in the sibling calibration kernel. \\
$n_{\mathrm{cal}}, n_{\mathrm{eff}}$ & Number of contributing sibling calibration records and their effective sample size. \\
$\hat c(z_u)$ & Context-weighted empirical-null inflation estimate for sibling parent $u$. \\
