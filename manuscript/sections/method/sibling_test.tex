...
null weights. To penalize degenerate one-record calibration, the implementation
multiplies $\hat c(z_u)$ by
\[
1 + \min\!\left(1,\frac{0.01}{\alpha_{\mathrm{sib}}}\right)
\frac{1}{6}\log\!\left(\frac{n_{\mathrm{cal}}}{n_{\mathrm{eff}}}\right).
\]
[TODO: justify the effective-sample penalty form, the divisor 6, and the
reference level 0.01 with calibration evidence or a derivation. If this remains
an implementation safeguard, label it as such and report sensitivity.]
