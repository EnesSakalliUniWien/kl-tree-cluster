...
stopped-path support. The current estimator includes nested blocked descendants
as node records; therefore its reported record count and weight-only effective
sample size are not counts of independent stopping events. If both support sets
are empty but $\mathcal C_u$ has positive
