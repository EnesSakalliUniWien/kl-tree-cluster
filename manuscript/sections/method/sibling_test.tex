...
null weights. The implementation reports this effective sample size as
diagnostic information. It is not an additional multiplier in
\(\hat c(z_u)\), and it is not currently used as a hard threshold for accepting
or rejecting calibration support.
