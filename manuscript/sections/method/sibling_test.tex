...
post-selection scale of the projected-Wald statistic from the empirical null
visible inside the fitted hierarchy. For every binary parent $q$, let
$T_q^{\mathrm{raw}}$ be the raw sibling statistic, let $\nu_q$ be the effective
sibling degrees of freedom returned by the projected-Wald kernel, let
