...
looks from the edge stage, and a scalar context used to borrow information
across similar projection dimensions.

For every binary parent $q$, let $T_q^{\mathrm{raw}}$ be the raw sibling
...
implied by the two child-parent edge tests. In the current implementation,
\begin{equation}
\pi_q =
\left(
...
calibration contract is unsatisfied.
