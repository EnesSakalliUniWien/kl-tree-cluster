...
space. This expansion creates deterministic within-feature constraints because
the indicators for one categorical variable sum to one; the current method
operates on the expanded indicator coordinates and does not separately model a
multinomial block covariance.
...
features.]
Continuous inputs enter through an explicit preprocessing map into a
discrete representation. One basic option is median binarization,
\begin{equation}
X_{ij}^{\mathrm{bin}}
=
\mathbf{1}\!\left\{
