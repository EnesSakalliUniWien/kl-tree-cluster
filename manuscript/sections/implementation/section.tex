...
Sibling basis / calibration & Parent PCA head capped to available rank; Satterthwaite raw test; weighted $\hat c$ localized by a Gaussian kernel in log-structural-dimension space \\
