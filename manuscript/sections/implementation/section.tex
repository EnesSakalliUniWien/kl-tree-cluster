...
Sibling test & Projected Wald test with context-weighted empirical-null inflation \\
Sibling dimension rule & Geometric mean of positive child edge dimensions \\
Sibling basis / inflation & Parent PCA head capped to available rank; projected chi-square raw test; empirical inflation $\hat c$ estimated from sibling records \\
