...
Edge test & Satterthwaite-calibrated projected Wald test using the parent-specific PCA spectrum \\
Edge dimension rule & Marchenko--Pastur signal count from the parent's local spectrum \\
Sibling test & Projected Wald test with global null-like calibration \\
Sibling dimension rule & Geometric mean of positive child edge dimensions \\
Sibling basis / calibration & Parent PCA head capped to available rank; Satterthwaite raw test; global $\hat c$ estimated from null-like sibling pairs \\
