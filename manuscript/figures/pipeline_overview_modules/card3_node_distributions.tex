...
\node[
	...
	{feature-wise subtree means from descendant leaves};
...
\node[
	...
	align=right,
	text width=3.20cm,
] at ($(p3.north east)+(-0.12,-0.42)$)
	{$\theta_u = \mathrm{mean}_{i \in L(u)} X_i$};
...
\node[tinylabel, anchor=north] at ($(a3)+(0,-0.22)$) {$A$};
\node[tinylabel, anchor=north] at ($(b3)+(0,-0.22)$) {$B$};
\node[tinylabel, anchor=north] at ($(c3)+(0,-0.22)$) {$C$};
\node[tinylabel, anchor=north] at ($(d3)+(0,-0.22)$) {$D$};
\matrix[
	matrix of nodes,
	anchor=south,
	row sep=0pt,
