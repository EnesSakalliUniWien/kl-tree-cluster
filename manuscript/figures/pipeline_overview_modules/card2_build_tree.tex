...
\node[tinylabel, anchor=north] at ($(a2)+(0,-0.22)$) {$A$};
\node[tinylabel, anchor=north] at ($(b2)+(0,-0.22)$) {$B$};
\node[tinylabel, anchor=north] at ($(c2)+(0,-0.22)$) {$C$};
\node[tinylabel, anchor=north] at ($(d2)+(0,-0.22)$) {$D$};
