...
\end{scope}
\node[tinylabel, anchor=north] at ($(a6)+(0,-0.22)$) {$A$};
\node[tinylabel, anchor=north] at ($(b6)+(0,-0.22)$) {$B$};
\node[tinylabel, anchor=north] at ($(c6)+(0,-0.22)$) {$C$};
\node[tinylabel, anchor=north] at ($(d6)+(0,-0.22)$) {$D$};
\node[tinylabel, anchor=north] at ($(p6.south)+(-0.95,0.42)$) {cluster 1};
\node[tinylabel, anchor=north] at ($(p6.south)+(0.95,0.42)$) {cluster 2};
