...
| `_CalibrationModel`                                     | Dataclass: fitted inflation model — method, coefficients, max_observed_ratio.                                                                                                                       |
...
| `_predict_c(model, bl_sum, n_parent)`                   | Predict ĉ for a focal pair. Clamped to `[1.0, max_observed_ratio]`.                                                                                                                                 |
