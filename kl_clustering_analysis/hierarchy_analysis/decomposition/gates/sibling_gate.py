...
def annotate_sibling_gate(
    ...
    *,
    ...
    from kl_clustering_analysis.hierarchy_analysis.statistics.sibling_divergence.parametric_wald_annotation import (
    ...
    calibrators = {
        ...
        "parametric_wald": annotate_sibling_divergence_parametric,
    }
