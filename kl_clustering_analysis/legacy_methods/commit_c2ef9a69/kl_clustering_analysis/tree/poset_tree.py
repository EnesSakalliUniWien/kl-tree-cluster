...
from kl_clustering_analysis.legacy_methods.commit_c2ef9a69.kl_clustering_analysis.hierarchy_analysis.cluster_assignments import (
...
from kl_clustering_analysis.legacy_methods.commit_c2ef9a69.kl_clustering_analysis.tree.distributions import (
...
class PosetTree(nx.DiGraph):
    ...
    * utility accessors (:meth:`get_leaves`, :meth:`compute_descendant_sets`)
    ...
    def from_agglomerative(
        ...
        """
        from kl_clustering_analysis.legacy_methods.commit_c2ef9a69.kl_clustering_analysis.tree.io import (
