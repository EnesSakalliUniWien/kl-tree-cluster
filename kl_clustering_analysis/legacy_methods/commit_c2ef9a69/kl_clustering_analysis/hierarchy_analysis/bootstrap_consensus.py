...
Example
-------
>>> from kl_clustering_analysis.legacy_methods.commit_c2ef9a69.kl_clustering_analysis.hierarchy_analysis.bootstrap_consensus import (
...     bootstrap_consensus,
... )
...
def bootstrap_consensus(
    ...
    *,
    ...
    from kl_clustering_analysis.legacy_methods.commit_c2ef9a69.kl_clustering_analysis.tree.poset_tree import (
        PosetTree,  # local import to avoid cycles
    )
