# HC_feature_matrix_Reactome_Pathways.tsv

Binary gene × pathway membership matrix for **hypertrophic cardiomyopathy (HC)** associated genes, annotated with **Reactome** pathway terms.
...
data = pd.read_csv("data/HC_feature_matrix_Reactome_Pathways.tsv", sep="\t", index_col=0)
# data.shape → (317, 1834)
```
...
| ------- | --------------------------------- | -------- | ----------------------------------------------------------------------------------------- |
| 0.01    | `benchmarks/results/02_hc_cms_go_runs/data_alpha_runs/results_Reactome_alpha_001/`     | 79       | cluster_assignments.csv, data_with_clusters.tsv, tree_clusters.png/pdf, umap_clusters.png |
| 0.05    | `benchmarks/results/02_hc_cms_go_runs/data_alpha_runs/results_Reactome_alpha_005/`     | 85       | cluster_assignments.csv, data_with_clusters.tsv, tree_clusters.png/pdf, umap_clusters.png |
| 0.10    | `benchmarks/results/02_hc_cms_go_runs/data_alpha_runs/results_Reactome_alpha_010/`     | 85       | cluster_assignments.csv, data_with_clusters.tsv, tree_clusters.png/pdf, umap_clusters.png |
| default | `benchmarks/results/02_hc_cms_go_runs/data_alpha_runs/results_Reactome_alpha_default/` | 85       | cluster_assignments.csv, umap_clusters.png                                                |
...
python scripts/run_feature_matrix_with_umap.py \
    --input data/HC_feature_matrix_Reactome_Pathways.tsv \
    --output-dir benchmarks/results/02_hc_cms_go_runs/data_alpha_runs/results_Reactome_alpha_005 \
    --alpha-local 0.05 --sibling-alpha 0.05
```

## Note

This file is **byte-identical** to `HC_feature_matrix_GO_CC.tsv`. Both contain the same 317 × 1 834 Reactome pathway membership matrix. The two filenames were kept for provenance tracking.
