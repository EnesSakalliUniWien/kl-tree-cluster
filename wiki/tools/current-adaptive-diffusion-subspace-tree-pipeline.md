...
Use `scripts/analysis/run_current_adaptive_diffusion_subspace_tree_experiment.py`
...
```bash
MPLBACKEND=Agg python scripts/analysis/run_current_adaptive_diffusion_subspace_tree_experiment.py \
