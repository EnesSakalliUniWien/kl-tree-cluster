...
sources:
  ...
  - scripts/analysis/build_subspace_gene_annotation_pdf.py
  - scripts/analysis/export_subspace_cluster_rosters.py
  - scripts/analysis/audit_go_cluster_meaningfulness.py
  - scripts/rest_request.py
  - scripts/analysis/audit_go_annotation_analysis_levels.py
...
Use `scripts/analysis/run_go_annotation_feature_matrix_pipeline.py` as the
...
```bash
MPLBACKEND=Agg python scripts/analysis/run_go_annotation_feature_matrix_pipeline.py \
...
`scripts/analysis/audit_go_cluster_meaningfulness.py` as an internal
...
- `scripts/analysis/run_go_annotation_feature_matrix_pipeline.py` writes the
  canonical stage commands, manifest, and dry-run plan.
- `scripts/analysis/inventory_go_annotation_datasets.py` writes dataset,
  duplicate, result-root, and naming-convention inventories.
- `scripts/analysis/build_subspace_gene_annotation_pdf.py` writes systematic
  ranked two-page-per-subspace PDFs and accompanying cluster/gene
  interpretation CSVs.
- `scripts/analysis/export_subspace_cluster_rosters.py` writes the complete
...
- `scripts/analysis/audit_go_cluster_meaningfulness.py` writes internal
...
- `scripts/analysis/audit_go_annotation_analysis_levels.py` classifies existing
