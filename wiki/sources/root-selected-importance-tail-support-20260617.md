...
sources:
  ...
  - benchmarks/diagnostics/calibration/root_tie_rank_generated_neighborhood_replay.py
  ...
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_importance_external_null_frontier_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_importance_external_null_replay_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_importance_external_null_topology_join_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_selected_spectral_tail_law_importance_external_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_selected_spectral_tail_law_importance_external_smoke/root_selected_spectral_tail_law_rows.csv
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_selected_spectral_tail_law_importance_external_smoke/root_selected_spectral_tail_law_summary.csv
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_importance_external_null_frontier_mild_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_importance_external_null_replay_mild_smoke/manifest.json
  ...
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_selected_spectral_tail_law_importance_external_mild_accumulated/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_importance_external_null_frontier_twoblock013_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_importance_external_null_frontier_twoblock012_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_importance_external_null_frontier_mild_hu_replay_v3_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_importance_external_null_replay_mild_hu_replay_v3_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_importance_external_null_topology_join_mild_hu_replay_v3_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_selected_spectral_tail_law_importance_external_mild_hu_replay_v3_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_selected_spectral_tail_law_deformed_hu_mild_replay_v3_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_selected_spectral_tail_law_deformed_hu_mild_replay_v3_smoke/root_selected_spectral_tail_law_rows.csv
tags:
  - source
  - diagnostics
  - root
