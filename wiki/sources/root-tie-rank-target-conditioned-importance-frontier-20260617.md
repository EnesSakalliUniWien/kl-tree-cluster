...
updated: 2026-06-17
sources:
  - benchmarks/diagnostics/calibration/root_tie_rank_target_conditioned_importance_frontier.py
  - tests/validation/170_test_root_tie_rank_target_conditioned_importance_frontier.py
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_target_conditioned_importance_frontier_narrow_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_target_conditioned_importance_frontier_narrow_smoke/target_conditioned_importance_summary.csv
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_target_conditioned_importance_frontier_narrow_smoke/target_conditioned_importance_target_rows.csv
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_target_conditioned_importance_frontier_coupled_narrow_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_target_conditioned_importance_frontier_coupled_narrow_smoke/target_conditioned_importance_summary.csv
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_target_conditioned_importance_frontier_coupled_narrow_smoke/target_conditioned_importance_target_rows.csv
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_target_conditioned_importance_frontier_unbalanced_mod_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_target_conditioned_importance_frontier_unbalanced_mod_boundary_probe/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_target_conditioned_importance_frontier_unbalanced_mod_delta126_probe/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_target_conditioned_importance_frontier_unbalanced_mod_rejection_smoke/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_target_conditioned_importance_frontier_unbalanced_mod_boundary_fine_probe/manifest.json
  - raw/assets/benchmark-results/specific_small_method_benchmark_20260615/root_tie_rank_target_conditioned_importance_frontier_two_factor_mod_smoke/manifest.json
tags:
  - source
  - diagnostics
  - root
