    ...
    if not args.skip_current_subspace and not args.skip_subspace_package:
        ...
        stages.append(
            PipelineStage(
                ...
                command=[
                    args.python,
                    str(repo_root / "scripts/analysis/export_subspace_cluster_rosters.py"),
                    "--experiment-dir",
                    str(experiment_dir),
                    "--feature-matrix",
                    str(args.input),
        ...
        pdf_command = [
            args.python,
            str(repo_root / "scripts/analysis/build_subspace_gene_annotation_pdf.py"),
            "--feature-matrix",
            str(args.input),
            "--experiment-dir",
            str(experiment_dir),
        ...
        stages.append(
            PipelineStage(
                ...
                command=[
                    args.python,
                    str(repo_root / "scripts/analysis/audit_go_cluster_meaningfulness.py"),
                    "--dataset-label",
                    artifact_prefix,
                    "--feature-matrix",
                    str(args.input),
