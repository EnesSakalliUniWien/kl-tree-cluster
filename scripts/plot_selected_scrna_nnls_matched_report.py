"""Matched adult/Goncalves NNLS-TBS report with identical page structure."""
# ruff: noqa: I001
...
from scripts.plot_selected_scrna_nnls_fit_summary import _fit_diagnostic, _plot_fit
        ...
        json.dumps(
            {
                ...
                "source_scripts": [
                    "scripts/plot_selected_scrna_nnls_matched_report.py",
                    "scripts/plot_selected_scrna_nnls_report.py",
                    "scripts/plot_selected_scrna_nnls_fit_summary.py",
                ],
