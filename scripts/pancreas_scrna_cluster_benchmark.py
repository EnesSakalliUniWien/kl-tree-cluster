...
def _scanpy_version() -> str:
    try:
        return str(_scanpy_module().__version__)
...
def _decompose_with_hypothetical_edge_annotations(
    *,
    ...
    labels, _report = _labels_and_report_from_decomposition(
...
def _run_benchmarks(
    ...
    *,
    ...
    try:
        adaptive_distance, metadata = _build_adaptive_diffusion_distance(
            X_df,
            k_neighbors=15,
            diffusion_time=3,
            n_components=n_pcs,
