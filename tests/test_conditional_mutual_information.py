#!/usr/bin/env python3
"""
Tests for conditional mutual information (CMI) utilities.
...
class TestCMI:
    ...
    def test_cmi_binary_vec_basic(self):
        ...
        from kl_clustering_analysis.information_metrics import _cmi_binary_vec
    ...
    def test_perm_test_cmi_binary_basic(self):
        ...
        from kl_clustering_analysis.information_metrics import _perm_test_cmi_binary
    ...
    def test_perm_cmi_binary_batch(self):
        ...
        from kl_clustering_analysis.information_metrics import _perm_cmi_binary_batch
    ...
    def test_consistency_across_implementations(self):
        ...
        from kl_clustering_analysis.information_metrics import _mi_binary_vec_accel
