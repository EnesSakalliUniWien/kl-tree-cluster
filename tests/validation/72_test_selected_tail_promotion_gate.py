...
from benchmarks.diagnostics.calibration.selected_tail_promotion_gate import (
    DEFAULT_Q5_MODEL_ID,
    STUDY_ROLE,
...
def test_q5_promotion_gate_blocks_parent_size_transfer_failure() -> None:
    gate_table, gate = evaluate_q5_promotion_gate(
    ...
    parent_row = gate_table[
        gate_table["split_strategy"].eq("leave_one_parent_size_bin_out")
    ].iloc[0]
