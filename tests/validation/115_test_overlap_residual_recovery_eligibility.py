...
import pandas as pd
from benchmarks.diagnostics.calibration.overlap_residual_recovery_eligibility import (
...
def test_residual_recovery_threshold_summary_counts_retention() -> None:
    ...
    null_threshold = thresholds[
        thresholds["threshold_name"].eq("null_evidence_threshold")
    ].iloc[0]
