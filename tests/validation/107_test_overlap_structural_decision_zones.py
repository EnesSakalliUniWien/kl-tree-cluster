...
from benchmarks.diagnostics.calibration.overlap_structural_decision_zones import (
...
def test_decision_zone_summary_counts_truth_roles() -> None:
    ...
    stable = summary[
        summary["structural_decision_zone"].eq("stable_structural_accept")
    ].iloc[0]
    weak = summary[
        summary["structural_decision_zone"].eq("unstable_weak_homogeneity_zone")
    ].iloc[0]
