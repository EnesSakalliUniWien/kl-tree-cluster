...
import pandas as pd
from benchmarks.diagnostics.calibration.spectral_transport.spectral_transport_promotion_gate import (
    BASELINE_METHOD,
    BASELINE_PROFILE,
    CANDIDATE_METHOD,
    CANDIDATE_PROFILE,
...
def test_promotion_gate_defaults_use_replicate_selected_family_evidence(
    ...
    assert "selected_family_traversal_spectral_transport_promoted_replicates" in str(
        config.selected_family_rows_path
    )
