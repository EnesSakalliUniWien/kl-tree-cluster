...
import pandas as pd
import pytest
from benchmarks.diagnostics.calibration.edge.edge_null_calibration_panel import (
    STUDY_ROLE,
...
def test_edge_null_panel_scores_context_roles() -> None:
    ...
    selected_null = summary[summary["edge_context_role"].eq("selected_tree_null")].iloc[0]
    selected_signal = summary[summary["edge_context_role"].eq("selected_tree_signal")].iloc[0]
