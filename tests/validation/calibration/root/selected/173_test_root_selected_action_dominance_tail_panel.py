...
def test_action_dominating_support_does_not_become_production_p_value() -> None:
    ...
    assert row["production_inference_status"] == ("fail_closed_action_dominance_diagnostic_only")
...
def test_action_dominance_summary_counts_new_diagnostic_support() -> None:
    ...
    assert summary["summary_status"] == ("one_sided_action_dominance_diagnostic_support_available")
