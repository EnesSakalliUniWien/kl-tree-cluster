...
def test_selects_only_external_law_targets() -> None:
    rows = pd.DataFrame.from_records(
        [
            ...
            {
                "target_case_id": "done",
                "external_law_equation_status": ("existing_tail_support_defer_to_tail_panel"),
...
def test_h_u_missing_external_rows_are_not_tail_support() -> None:
    ...
    deformed_support = pd.DataFrame.from_records(
        [
            ...
            {
                "case_id": "missing_hu",
                "support_deformed_mp_edge_status": ("support_deformed_mp_edge_missing_inputs"),
            },
        ]
    )
...
def test_attempt_rows_count_new_same_geometry_nonzero_support() -> None:
    ...
    rows = panel.build_same_geometry_external_support_attempt_rows(
        ...
        replay_rows=pd.DataFrame.from_records([{"case_id": "new_support", "run_status": "ok"}]),
    ...
    assert summary["summary_status"] == ("new_same_geometry_tail_exceedance_support_observed")
