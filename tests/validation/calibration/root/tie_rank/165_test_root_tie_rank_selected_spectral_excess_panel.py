...
def test_selected_spectral_excess_separates_hard_and_missing_support() -> None:
    ...
    spectral = panel.build_selected_spectral_excess_rows(rows).set_index("target_case_id")

    assert spectral.loc["hard", "spectral_excess_status"] == ("spectral_excess_hard_residual")
