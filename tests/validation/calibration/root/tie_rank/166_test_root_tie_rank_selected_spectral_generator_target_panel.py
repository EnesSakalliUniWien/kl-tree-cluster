...
def test_generator_targets_distinguish_calibration_reach_and_missing_stratum() -> None:
    ...
    assert iid_easy["generator_target_status"] == ("calibration_generator_reaches_spectral_target")
    assert iid_easy["conditioning_stratum_status"] == ("family_stratum_has_selected_null_support")
    assert sparse_easy["generator_target_status"] == ("conditioning_stratum_missing_for_family")
    assert iid_hard["generator_target_status"] == ("conditioning_stratum_missing_for_family")
