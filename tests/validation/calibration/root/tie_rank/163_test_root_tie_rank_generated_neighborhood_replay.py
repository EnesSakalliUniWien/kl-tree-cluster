...
def test_generated_replay_builds_topology_frontier_rows(
    ...
    monkeypatch.setattr(
        ...
        lambda *, case_id, data_role, method_id, replicate, data_seed, result: _node_decisions(
    ...
    root = (
        tables["topology_rows"]
        .loc[tables["topology_rows"]["candidate_scope"].eq("root_non_direct")]
        .iloc[0]
    )
