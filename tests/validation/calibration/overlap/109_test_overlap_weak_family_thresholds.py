...
import pandas as pd
import pytest
from benchmarks.diagnostics.calibration.overlap.overlap_weak_family_thresholds import (
...
def test_family_threshold_summary_keeps_positive_family_at_zero_negative() -> None:
    ...
    combined = summary[summary["comparison"].eq("aligned_family_vs_null_or_misaligned")].iloc[0]
