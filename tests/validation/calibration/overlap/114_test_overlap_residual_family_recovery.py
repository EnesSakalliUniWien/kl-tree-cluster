...
import pandas as pd
from benchmarks.diagnostics.calibration.overlap.overlap_residual_family_recovery import (
...
def test_residual_family_metric_summary_reports_auc() -> None:
    ...
    vs_nonrecovery = summary[summary["comparison"].eq("recovery_vs_nonrecovery")].iloc[0]
