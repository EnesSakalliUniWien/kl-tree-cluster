...
import pandas as pd
from benchmarks.diagnostics.calibration.overlap.overlap_context_negative_topology_transfer import (
...
def test_topology_transfer_reports_missing_holdout_truth_support() -> None:
    ...
    assert summary["diagnostic_status"].iloc[0] == ("transfer_unvalidated_no_truth_holdout_support")
