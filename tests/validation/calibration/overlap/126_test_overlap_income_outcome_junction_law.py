...
import pandas as pd
from benchmarks.diagnostics.calibration.overlap.overlap_income_outcome_junction_law import (
...
def test_income_outcome_summary_reports_transition_law_required() -> None:
    ...
    assert summary["diagnostic_status"].iloc[0] == ("income_outcome_transition_law_required")
