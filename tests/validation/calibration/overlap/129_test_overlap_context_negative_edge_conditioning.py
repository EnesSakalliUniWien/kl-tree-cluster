...
import pandas as pd
from benchmarks.diagnostics.calibration.overlap.overlap_context_negative_edge_conditioning import (
...
def test_edge_conditioning_finds_zero_negative_separator() -> None:
    ...
    assert summary["diagnostic_status"].iloc[0] == ("edge_conditioning_separator_found")
...
def test_edge_conditioning_reports_no_separator_when_truth_overlaps_negatives() -> None:
    ...
    assert summary["diagnostic_status"].iloc[0] == ("edge_conditioning_no_zero_negative_separator")
