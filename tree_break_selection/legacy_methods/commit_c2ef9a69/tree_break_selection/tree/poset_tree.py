...
from tree_break_selection.legacy_methods.commit_c2ef9a69.tree_break_selection.core_utils.tree_utils import (
    bottom_up_nodes,
    compute_node_depths,
)
from tree_break_selection.legacy_methods.commit_c2ef9a69.tree_break_selection.hierarchy_analysis.cluster_assignments import (
...
from tree_break_selection.legacy_methods.commit_c2ef9a69.tree_break_selection.tree.distributions import (
...
class PosetTree(nx.DiGraph):
    ...
    * utility accessors (:meth:`get_leaves`, :meth:`compute_descendant_sets`)
    ...
    def from_agglomerative(
        ...
        """
        from tree_break_selection.legacy_methods.commit_c2ef9a69.tree_break_selection.tree.io import (
            tree_from_agglomerative,
        )
    ...
    def decompose(
        ...
        **decomposer_kwargs,
        ...
        leaf_data
            ...
            initialize node distributions/TBS metrics prior to decomposition.
        **decomposer_kwargs
    ...
    def build_sample_cluster_assignments(
        ...
        :meth:`tree_break_selection.hierarchy_analysis.tree_decomposition.TreeDecomposition.build_sample_cluster_assignments`.
